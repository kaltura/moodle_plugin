...
?>
 <button type="button" class="btn btn-primary mt-2 mb-2 " style=" background-color: #008297; border-color: #008297 !important;" onClick="parent.location='mymedia.php'" >BACK TO MY MEDIA </button>

<div class="container-fluid">
  <div class="row">
  <div class="col-sm|md|lg">
  <div class="card mt-2">
